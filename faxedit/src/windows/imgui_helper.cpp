...
bool fe::ui::imgui_checkbox(const std::string& p_label, bool& p_val,
...
bool fe::ui::imgui_checkbox(const std::string& p_label, char& p_val,
	const std::string& p_tooltip) {
	bool l_val{ static_cast<bool>(p_val) };
	bool result{ imgui_checkbox(p_label, l_val, p_tooltip) };
