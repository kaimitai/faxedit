...
namespace {
	...
	{ 14, {
		...
		fh::GeneralHackLib::AtlasDevYareekaControl,
	}},
	{ 15, {
		...
		fh::GeneralHackLib::AtlasDevEnemyHud,
		...
		fh::GeneralHackLib::AtlasDevZorugeriruControl,
	...
	const std::map<fh::GeneralHackLib, std::set<std::string>> GENERAL_HACK_PARAMS{
		...
		{ fh::GeneralHackLib::AtlasDevQueueLess, { "dedup" } },
		{ fh::GeneralHackLib::AtlasDevPreventTextbox, { "textbox" } },
		...
		{ fh::GeneralHackLib::AtlasDevZorugeriruControl, { "rest", "windup", "cap", "fall", "body", "flag", "mode" } },
